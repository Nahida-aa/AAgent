//! 主题颜色 settings 类型。
//!
//! 对齐 Zed `settings_content::theme.rs` 中的颜色部分。
...
/// 诊断/VCS 状态色（conflict/created/deleted/error/hidden/hint/ignored/info/modified/predictive/renamed/success/unreachable/warning）。
///
...
pub struct ThemeStyleContent {
    ...
    /// 语法高亮。
    #[serde(default)]
    pub syntax: std::collections::BTreeMap<String, HighlightStyleContent>,
}
