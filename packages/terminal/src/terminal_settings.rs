...
impl From<settings_content::CursorShapeContent> for CursorShape {
    fn from(value: settings_content::CursorShapeContent) -> Self {
        match value {
            settings_content::CursorShapeContent::Block => CursorShape::Block,
            settings_content::CursorShapeContent::Underline => CursorShape::Underline,
            settings_content::CursorShapeContent::Bar => CursorShape::Bar,
            settings_content::CursorShapeContent::Hollow => CursorShape::Hollow,
        }
    }
}
