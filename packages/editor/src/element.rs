...
impl EditorElement {
    ...
    pub fn set_split_side(&mut self, side: SplitSide) { self.split_side = Some(side); }
...
impl EditorLayout {
    fn line_end_overshoot(&self) -> Pixels { 0.15 * self.position_map.line_height }
}
...
mod tests {
    ...
    async fn test_status_bar_blame_location_reserves_no_scroll_width(cx: &mut TestAppContext) {
        ...
        impl BlameRenderer for FixedWidthBlameRenderer {
            fn max_author_length(&self) -> usize { 20 }
