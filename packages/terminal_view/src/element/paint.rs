...
use editor::{CursorLayout, EditorSettings, HighlightedRange};
use gpui::{
    App, Bounds, ContentMask, DispatchPhase, GlobalElementId, InputHandler, InspectorElementId,
    IntoElement, ModifiersChangedEvent, ParentElement, Pixels, Point as GpuiPoint, Styled,
