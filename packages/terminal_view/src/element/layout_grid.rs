...
use gpui::{
    App, Font, FontStyle, FontWeight, HighlightStyle, Hsla, Pixels, Point as GpuiPoint, TextRun,
    TextStyle, point,
};
...
use super::block_element::{BLOCK_SUBCELL_COLUMNS, BLOCK_SUBCELL_LINES, BlockElementLayoutRect};
use super::cell_style::{convert_color, is_blank};
use super::layout::{
    BackgroundRegion, BatchedTextRun, DisplayCursor, LayoutPoint, LayoutRect, TerminalLayoutCell,
