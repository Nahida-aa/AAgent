...
impl SessionId {
    pub fn from_proto(client_id: u64) -> Self { Self(client_id as u32) }
...
impl DebugAdapterClient {
    ...
    pub fn binary(&self) -> &DebugAdapterBinary { &self.binary }

    /// Get the next sequence id to be used in a request
    pub fn next_sequence_id(&self) -> u64 { self.sequence_count.fetch_add(1, Ordering::Relaxed) }
    ...
    pub fn has_adapter_logs(&self) -> bool { self.transport_delegate.has_adapter_logs() }
