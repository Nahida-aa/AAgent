...
impl DiffOperations for RestoreDiffOperations {
    fn supports_staging(&self) -> bool { false }

    fn supports_unstaging(&self) -> bool { false }

    fn supports_restore(&self) -> bool { true }
}
...
impl DiffOperations for TestDiffOperations {
    fn supports_staging(&self) -> bool { true }

    fn supports_unstaging(&self) -> bool { true }
...
impl BufferDiffSnapshot {
    ...
    pub fn buffer_id(&self) -> BufferId { self.buffer_snapshot.remote_id() }

    pub fn buffer_snapshot(&self) -> &text::BufferSnapshot { &self.buffer_snapshot }
    ...
    pub fn base_text_exists(&self) -> bool { self.base_text_exists }

    pub fn secondary_diff(&self) -> Option<&BufferDiffSnapshot> { self.secondary_diff.as_deref() }

    pub fn buffer_version(&self) -> &clock::Global { self.buffer_snapshot.version() }
    ...
    pub fn base_text(&self) -> &language::BufferSnapshot { &self.base_text }
...
impl HunkSink<'_> {
    ...
    fn finish(self) -> Vec<InternalDiffHunk> { self.hunks }
}
...
impl BufferDiff {
    ...
    pub fn operations(&self) -> Option<Arc<dyn DiffOperations>> { self.operations.clone() }

    pub fn secondary_diff(&self) -> Option<Entity<BufferDiff>> { self.secondary_diff.clone() }
    ...
    pub fn base_text_buffer(&self) -> &Entity<language::Buffer> { &self.base_text_buffer }
}
...
impl DiffHunkStatus {
    ...
    pub fn is_deleted(&self) -> bool { self.kind == DiffHunkStatusKind::Deleted }

    pub fn is_added(&self) -> bool { self.kind == DiffHunkStatusKind::Added }

    pub fn is_modified(&self) -> bool { self.kind == DiffHunkStatusKind::Modified }
