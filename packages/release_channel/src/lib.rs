...
fn compile_time_release_channel_name() -> String { env!("ZED_RELEASE_CHANNEL").trim().to_string() }
...
impl ReleaseChannel {
    ...
    pub fn global(cx: &App) -> Self { cx.global::<GlobalReleaseChannel>().0 }
    ...
    pub fn poll_for_updates(&self) -> bool { !matches!(self, ReleaseChannel::Dev) }
