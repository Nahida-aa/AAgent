...
pub(crate) struct BackgroundScanner {
    ...
    pub(crate) status_updates_tx: UnboundedSender<ScanState>,
    pub(crate) executor: BackgroundExecutor,
    pub(crate) scan_requests_rx: async_channel::Receiver<ScanRequest>,
    pub(crate) path_prefixes_to_scan_rx: async_channel::Receiver<PathPrefixScanRequest>,
    pub(crate) next_entry_id: Arc<AtomicUsize>,
    pub(crate) phase: BackgroundScannerPhase,
    pub(crate) watcher: Arc<dyn Watcher>,
    pub(crate) settings: WorktreeSettings,
    pub(crate) share_private_files: bool,
    pub(crate) track_git_repositories: bool,
