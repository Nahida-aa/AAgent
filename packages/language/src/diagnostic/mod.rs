...
impl DiagnosticMessage {
    ...
    pub fn as_shared_string(&self) -> &SharedString { &self.text }
    ...
    pub fn has_lsp_markup(&self) -> bool { self.lsp_markup().is_some() }
...
impl Default for DiagnosticMessage {
    fn default() -> Self { Self::plain(SharedString::default()) }
}
...
impl From<String> for DiagnosticMessage {
    fn from(text: String) -> Self { Self::plain(SharedString::from(text)) }
}

impl From<&str> for DiagnosticMessage {
    fn from(text: &str) -> Self { Self::plain(SharedString::from(text)) }
}

impl From<SharedString> for DiagnosticMessage {
    fn from(text: SharedString) -> Self { Self::plain(text) }
}
