use gpui::{Along, App, Axis, Bounds, Pixels, point, size};
use schemars::JsonSchema;
use serde::Deserialize;
use settings::Settings;

use crate::workspace_settings::{
    PaneSplitDirectionHorizontal, PaneSplitDirectionVertical, WorkspaceSettings,
};
...
impl SplitDirection {
    pub fn all() -> [Self; 4] { [Self::Up, Self::Down, Self::Left, Self::Right] }
