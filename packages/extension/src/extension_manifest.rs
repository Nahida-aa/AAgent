...
impl SchemaVersion {
    ...
    pub fn is_v0(&self) -> bool { self == &Self::ZERO }
}
...
impl From<&str> for ExtensionSnippets {
    fn from(value: &str) -> Self { ExtensionSnippets::Single(value.into()) }
}
...
impl ExtensionManifest {
    ...
    pub fn allow_remote_load(&self) -> bool { self.remote_load().is_some() }
