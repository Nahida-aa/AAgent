...
pub struct LayoutState {
    ...
    pub(super) batched_text_runs: Vec<BatchedTextRun>,
    pub(super) block_element_rects: Vec<BlockElementLayoutRect>,
    pub(super) rects: Vec<LayoutRect>,
    pub(super) relative_highlighted_ranges: Vec<(Range, Hsla)>,
    pub(super) cursor: Option<CursorLayout>,
    pub(super) ime_cursor_bounds: Option<Bounds<Pixels>>,
    pub(super) background_color: Hsla,
    pub(super) dimensions: TerminalBounds,
    pub(super) mode: Modes,
    pub(super) display_offset: usize,
    pub(super) hyperlink_tooltip: Option<AnyElement>,
    pub(super) block_below_cursor_element: Option<AnyElement>,
...
impl DisplayCursor {
    pub(super) fn from(cursor_point: Point, display_offset: usize) -> Self {
        Self {
...
impl LayoutPoint {
    pub(crate) fn new(line: i32, column: i32) -> Self { Self { line, column } }
...
impl BatchedTextRun {
    ...
    pub(super) fn append_char(&mut self, c: char) { self.append_char_internal(c, true); }
...
impl LayoutRect {
    pub(super) fn new(point: LayoutPoint, num_of_cells: usize, color: Hsla) -> LayoutRect {
        LayoutRect {
            point,
            num_of_cells,
            color,
