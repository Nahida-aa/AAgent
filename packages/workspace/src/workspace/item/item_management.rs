...
impl Workspace {
    ...
    // create_entry / copy_entry / rename_entry / trash_file / delete_file / trash_entry
    // delete_entry / restore_entry / expand_entry / expand_all_for_entry
    // find_or_create_worktree / find_worktree / create_worktree / remove_worktree / ...
    ...
    // project_path_for_path / absolute_path / most_recent_active_path
    ...
    // pane_containing_project_item / pane_for / pane_for_item_id / pane_for_entity_id
    // activate_item / register_buffer / request_buffer_diff_recalculation
    // register_action / register_action_renderer
