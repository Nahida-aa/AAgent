...
impl Deref for Notifications {
    ...
    fn deref(&self) -> &Self::Target { &self.notifications }
}

impl std::ops::DerefMut for Notifications {
    fn deref_mut(&mut self) -> &mut Self::Target { &mut self.notifications }
}
...
impl NotificationId {
    ...
    pub const fn unique<T: 'static>() -> Self { Self::Unique(TypeId::of::<T>()) }
    ...
    pub fn named(id: SharedString) -> Self { Self::Named(id) }
}
...
impl Focusable for LanguageServerPrompt {
    fn focus_handle(&self, _cx: &App) -> gpui::FocusHandle { self.focus_handle.clone() }
}
...
pub mod simple_message_notification {
    ...
    impl AutoHideState {
        ...
        fn needs_animation_frame(&self) -> bool { self.fade.is_some() }
    ...
    impl MessageNotification {
        ...
        pub fn dismiss(&mut self, cx: &mut Context<Self>) { cx.emit(DismissEvent); }
    ...
    impl Component for MessageNotification {
        fn scope() -> ComponentScope { ComponentScope::Notification }
        ...
        fn preview(_window: &mut Window, cx: &mut App) -> AnyElement {
            ...
            impl WorkspaceError for PreviewError {
                ...
                fn primary_action(&self) -> ErrorAction { ErrorAction::dismiss() }
            ...
            impl WorkspaceError for BasicError {
                fn primary_message(&self) -> SharedString { "Failed to save the file.".into() }
                fn primary_action(&self) -> ErrorAction { ErrorAction::dismiss() }
                fn severity(&self) -> ErrorSeverity { ErrorSeverity::Critical }
            }
            ...
            impl WorkspaceError for UpdateRequiredError {
                ...
                fn secondary_action(&self) -> Option<ErrorAction> { Some(ErrorAction::dismiss()) }
            }
