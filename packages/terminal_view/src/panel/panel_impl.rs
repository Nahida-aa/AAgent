...
impl Panel for TerminalPanel {
    ...
    fn position_is_valid(&self, _: DockPosition) -> bool { true }
    ...
    fn set_active(&mut self, active: bool, window: &mut Window, cx: &mut Context<Self>) {
        ...
        cx.defer_in(window, |this, window, cx| {
            ...
            this.add_terminal_shell(false, kind, task::RevealStrategy::Always, window, cx)
    ...
    fn persistent_name() -> &'static str { "TerminalPanel" }

    fn panel_key() -> &'static str { super::actions::TERMINAL_PANEL_KEY }
    ...
    fn toggle_action(&self) -> Box<dyn gpui::Action> { Box::new(Toggle) }

    fn pane(&self) -> Option<Entity<Pane>> { Some(self.active_pane.clone()) }

    fn activation_priority(&self) -> u32 { 2 }
