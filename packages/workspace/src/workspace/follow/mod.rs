...
impl Workspace {
    // leader_for_pane / leader_updated / active_item_for_agent / active_item_for_peer
    // shared_screen_for_peer
    // start_following / follow_next_collaborator / follow / unfollow / is_being_followed
    // unfollow_in_pane / process_leader_update / add_view_from_leader
    // active_view_for_follower / handle_follow / handle_update_followers
    // handle_update_followers (top-level handler)
