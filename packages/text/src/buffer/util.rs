...
use super::fragment::{Fragment, FragmentBuilder, InsertionFragment, InsertionSlice};
use super::rope_builder::RopeBuilder;

pub(crate) fn push_fragments_for_insertion(
    new_text: &str,
    timestamp: clock::Lamport,
    insertion_offset: &mut u32,
    new_fragments: &mut FragmentBuilder,
    new_insertions: &mut Vec<SumTreeEdit<InsertionFragment>>,
