...
impl Pane {
    ...
    pub(super) fn change_tab_pin_state(
        &mut self,
        ix: usize,
    ...
    pub(super) fn is_tab_pinned(&self, ix: usize) -> bool { self.pinned_tab_count > ix }

    pub(super) fn has_unpinned_tabs(&self) -> bool { self.pinned_tab_count < self.items.len() }
